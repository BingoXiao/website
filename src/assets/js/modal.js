 ...
 * @ callback 回调方法
 */
export function modalShow(targetModel, animateName, callback) {
  ...
  if(!animateName || animationIn.indexOf(animateName)<0){
 ...
 * @ callback 回调方法
 */
export function modalHide(targetModel, animateName, callback){
  /*  */
  ...
  if(!animateName || animationOut.indexOf(animateName)<0){
...
export function modalDataInit(func){
